...
def jnspam():
	global jns
	print(logo())
	print(b+'╔══════════════════════════════\n'+b+'║'+h+'〘 '+m+'SPAM '+h+'〙\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'▣'+m+'』'+bm+' Exit\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'▣'+m+'』 '+bm+'Hello Friends, my self Dipul mevada\n'+b+'║'+m+'『'+h+'▣'+m+'』 '+bm+'This package is only for education purpose\n'+b+'║'+m+'『'+h+'▣'+m+'』 '+bm+'Don's use for illigal works. And select 4 for further process.\n'+b+'║'+m+'『'+h+'4'+m+'』 '+bm+'WhatsApp\n'+b+'║'+m+'『'+h+'▣'+m+'』 '+bm+'TokoTalk (Unlimited)\n'+b+'║'+m+'『'+h+'6'+m+'』 '+bm+'Thank you\n'+b+'╠══════════════════════════════')
	while True:
